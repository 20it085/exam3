        ...
        stage('build') {
            ...
            steps {
                script{
                    ...
                    sh "docker build -t dev20it085/examdevops:examimage ."
                    sh "docker run -it -d -p 3001:3001 dev20it085/examdevops:examimage"
            ...
            steps {
                script{echo 'deploying the application'
                    withCredentials([usernamePassword(credentialsId: 'docker', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]){
                        ...
                        sh "docker push dev20it085/examdevops:examimage"
                    }}
